...
const handleOnSubmit = (e) =>{
  ...
  return (
    ...
    <form onSubmit={handleOnSubmit} className='flex flex-col items-center justify-center'>
        ...
        <button type="submit" className='border py-3 px-2 rounded font-bold text-2xl bg-amber-400 hover:bg-amber-200 transition-transform duration-300 hover:scale-90 shadow-2xl'>submit</button>
    </form>
    </div>
