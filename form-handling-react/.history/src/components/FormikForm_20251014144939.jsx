        ...
        >
            {() => (
                <Form className='form-layout'>
                    <div className='p-3'>
                        <Field type="text" name="fullName" placeholder="Full Name" className='border-4 p-3'/>
                        {/* 3. Corrected name attribute */}
                        <ErrorMessage name="fullName" component="div" className='error-message' />
                    </div>

                    <div className='p-3'>
                        <Field type="email" name="email" placeholder="Email Address" className='border-4 p-3'/>
                        <ErrorMessage name="email" component="div" className='error-message' />
                    </div>

                    <div className='p-3'>
                        <Field type="password" name="password" placeholder="Password" className='border-4 p-3'/>
