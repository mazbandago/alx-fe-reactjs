            ...
            {() => (
                <Form className='form-layout'>
                    <div className='p-3'>
                        ...
                        <ErrorMessage name="fullName" component="div" className='p-3 mt-4' />
                    </div>
                    ...
                    <div className='p-3'>
                        ...
                        <ErrorMessage name="email" component="div" className='p-3 mt-4' />
                    </div>
                    ...
                    <div className='p-3'>
                        ...
                        <ErrorMessage name='password' component="div" className='p-3 mt-4' />
                    </div>
